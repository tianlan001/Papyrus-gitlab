...
//		BundleTestsUtils.testManifestProperty(siriusBundles, BundleTestsUtils.BUNDLE_REQUIREDEXECUTIONENVIRONMENT, BundleTestsUtils.JAVA_VERSION_REGEX, false, onlyOnJavaProject);
		...
		for (final Bundle current : PapyrusSiriusBundleUtils.getPapyrusSiriusBundles()) {
