 ...
 *****************************************************************************/
package org.eclipse.papyrus.sirius.uml.diagram.compositestructure.tests.delete.semantic.edges;
...
public class EdgeDeleteSemanticTest extends AbstractDeleteSemanticEdgeTest {
	...
	private static final String DIAGRAM_NAME = "DeleteEdgesCompositeStructureDiagramSirius"; //$NON-NLS-1$
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] {
				{ MappingTypes.SUBSTITUTION_EDGE_TYPE, SOURCE, UMLPackage.eINSTANCE.getClassifier_Substitution() },
				...
				{ MappingTypes.INFORMATION_FLOW_EDGE_TYPE, PACKAGE, UMLPackage.eINSTANCE.getPackage_PackagedElement() },
				{ MappingTypes.MANIFESTATION_EDGE_TYPE, PACKAGE, UMLPackage.eINSTANCE.getPackage_PackagedElement() }
		});
	}
}
