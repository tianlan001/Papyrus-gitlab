...
public class CreateTopNodeOnCompositeStructureTest extends AbstractCreateTopNodeOnDiagramTests {
	 ...
	 *
	 */
	public CreateTopNodeOnCompositeStructureTest(String creationToolId, String nodeMappingType, EReference containmentFeature, Class<? extends Element> expectedType) {
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] {
				...
				{ CreationToolsIds.CREATE__INFORMATION_ITEM__TOOL, MappingTypes.INFORMATION_ITEM_NODE_TYPE, UMLPackage.eINSTANCE.getPackage_PackagedElement(), InformationItem.class }
		});
	}
