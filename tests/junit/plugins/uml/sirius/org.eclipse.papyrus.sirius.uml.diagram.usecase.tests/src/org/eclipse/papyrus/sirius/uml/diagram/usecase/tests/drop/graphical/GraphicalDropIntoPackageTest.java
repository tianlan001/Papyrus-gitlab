...
/**
 * This class tests the graphical drop from the UseCase diagram into Package container.
 * 
 * @author <a href="mailto:jessy.mallet@obeo.fr">Jessy Mallet</a>
 */
@PluginResource("resources/drop/graphical/graphicalDrop.di")
@RunWith(value = Parameterized.class)
public class GraphicalDropIntoPackageTest extends AbstractGraphicalDropNodeTests {
	 ...
	 *
	 */
	public GraphicalDropIntoPackageTest(String elementToDropName, String dropToolId, String nodeMappingType) {
	...
	public void testDropToPackage() {
		dropElementIntoContainer(this.elementToDropName, PACKAGE_NEWCONTAINER, MappingTypes.PACKAGE_NODE_TYPE, MappingTypes.PACKAGE_NODE_PACKAGEDELEMENTS_COMPARTMENTS_TYPE, this.dropToolId, this.nodeMappingType);
	}
