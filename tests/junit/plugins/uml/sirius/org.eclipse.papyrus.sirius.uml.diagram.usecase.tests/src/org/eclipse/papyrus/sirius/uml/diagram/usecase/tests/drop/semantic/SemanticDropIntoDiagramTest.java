...
/**
 * This class tests the semantic drop into the UseCase diagram.
 * 
...
public class SemanticDropIntoDiagramTest extends AbstractSemanticTopNodeDropTests {
	...
	private static final String ACTOR = "Actor1"; //$NON-NLS-1$
	...
	private static final String USECASE = "UseCase1"; //$NON-NLS-1$

	private static final String DIAGRAM_NAME = "SemanticTopNodeDropUseCaseDiagramSirius"; //$NON-NLS-1$
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] {
				{ ACTIVITY, SemanticDropToolsIds.DROP__ACTIVITY__TOOL, MappingTypes.ACTIVITY_NODE_TYPE, List.of(MappingTypes.ACTIVITY_NODE_USECASES_COMPARTMENTS_TYPE) },
				{ ACTOR, SemanticDropToolsIds.DROP__ACTOR__TOOL, MappingTypes.ACTOR_NODE_TYPE, List.of() },
				{ CLASS, SemanticDropToolsIds.DROP__CLASS__TOOL, MappingTypes.CLASS_NODE_TYPE, List.of(MappingTypes.CLASS_NODE_USECASES_COMPARTMENTS_TYPE) },
				{ COMMENT, SemanticDropToolsIds.DROP__COMMENT__TOOL, MappingTypes.COMMENT_NODE_TYPE, List.of() },
				{ COMPONENT, SemanticDropToolsIds.DROP__COMPONENT__TOOL, MappingTypes.COMPONENT_NODE_TYPE, List.of(MappingTypes.COMPONENT_NODE_USECASES_COMPARTMENTS_TYPE) },
				{ CONSTRAINT, SemanticDropToolsIds.DROP__CONSTRAINT__TOOL, MappingTypes.CONSTRAINT_NODE_TYPE, List.of() },
				{ INTERACTION, SemanticDropToolsIds.DROP__INTERACTION__TOOL, MappingTypes.INTERACTION_NODE_TYPE, List.of(MappingTypes.INTERACTION_NODE_USECASES_COMPARTMENTS_TYPE) },
				{ PACKAGE, SemanticDropToolsIds.DROP__PACKAGE__TOOL, MappingTypes.PACKAGE_NODE_TYPE, List.of(MappingTypes.PACKAGE_NODE_PACKAGEDELEMENTS_COMPARTMENTS_TYPE) },
				{ STATEMACHINE, SemanticDropToolsIds.DROP__STATE_MACHINE__TOOL, MappingTypes.STATE_MACHINE_NODE_TYPE, List.of(MappingTypes.STATE_MACHINE_NODE_USECASES_COMPARTMENTS_TYPE) },
				{ USECASE, SemanticDropToolsIds.DROP__USE_CASE__TOOL, MappingTypes.USE_CASE_NODE_TYPE, List.of() },
		});
	}
