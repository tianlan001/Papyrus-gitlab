...
public class CreateTopNodeOnDeploymentTest extends AbstractCreateTopNodeOnDiagramTests {
	...
	public CreateTopNodeOnDeploymentTest(EReference containmentFeature, Class<? extends Element> expectedType) {
	...
	public void createTopNodeTest() {
		...
		final IGraphicalRepresentationElementCreationChecker graphicalNodeCreationChecker = new DNodeCreationChecker(diagram, this.getTopGraphicalContainer(), this.nodeMappingType);
