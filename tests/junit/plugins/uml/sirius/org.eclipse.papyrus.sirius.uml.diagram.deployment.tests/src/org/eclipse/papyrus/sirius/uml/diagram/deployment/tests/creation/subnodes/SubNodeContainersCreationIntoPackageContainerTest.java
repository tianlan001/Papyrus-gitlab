...
/**
 * Groups all tests related to sub-node container creation into a Package for the Deployment diagram.
 *
 * @author <a href="mailto:florian.barbin@obeo.fr">Florian Barbin</a>
 */
@PluginResource("resources/creation/subNodes/subNodes.di")
@RunWith(value = Parameterized.class)
public class SubNodeContainersCreationIntoPackageContainerTest extends AbstractCreateNodeTests {
	...
	public SubNodeContainersCreationIntoPackageContainerTest(Class<? extends Element> expectedType) {
	...
	public void createNodeContainerIntoModel() {
		...
		this.createNodeContainer(MODEL, MappingTypes.getCompartmentMappingType(modelName), UMLPackage.eINSTANCE.getPackage_PackagedElement());
	}
	...
	public void createNodeContainerIntoPackage() {
		...
		this.createNodeContainer(PACKAGE, MappingTypes.getCompartmentMappingType(packageName), UMLPackage.eINSTANCE.getPackage_PackagedElement());
	}
