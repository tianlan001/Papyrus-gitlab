...
public class EdgeReconnectionSourceControlFlowTest extends AbstractEdgeReconnectionSourceActivityEdgeTest {
	 ...
	 *
	 */
	public EdgeReconnectionSourceControlFlowTest(String newSourceName) {
		super(newSourceName);
	}
	...
	public void reconnectSourceControlFlowTest() {
		...
		reconnectSourceEdge(ReconnectionToolsIds.RECONNECT_SOURCE__CONTROL_FLOW__TOOL, edgeToReconnect);
	}

	@Parameters(name = "{index} reconnect source ControlFlow on {0}")
