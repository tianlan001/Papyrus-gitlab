...
public class CreateTopNodeContainerOnComponentTest extends AbstractCreateTopNodeOnDiagramTests {
	...
	public CreateTopNodeContainerOnComponentTest(String creationtoolId, String nodeMappingType, List<String> nodeCompartmentTypes, EReference containmentFeature, Class<? extends Element> expectedType) {
	...
	public void createTopNodeContainerTest() {
		...
		final IGraphicalRepresentationElementCreationChecker graphicalNodeCreationChecker = new DNodeContainerCreationChecker(diagram, getTopGraphicalContainer(), this.nodeMappingType, this.nodeCompartmentTypes);
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] {
				{ CreationToolsIds.CREATE__COMPONENT__TOOL, MappingTypes.COMPONENT_NODE_TYPE, List.of(MappingTypes.COMPONENT_NODE_CPD_ATTRIBUTES_COMPARTMENT_TYPE), UMLPackage.eINSTANCE.getPackage_PackagedElement(), Component.class },
				{ CreationToolsIds.CREATE__INTERFACE__TOOL, MappingTypes.INTERFACE_NODE_TYPE,
						...
						UMLPackage.eINSTANCE.getPackage_PackagedElement(), Interface.class },
				{ CreationToolsIds.CREATE__MODEL__TOOL, MappingTypes.MODEL_NODE_TYPE, List.of(MappingTypes.MODEL_NODE_CPD_PACKAGED_ELEMENTS_COMPARTMENT_TYPE), UMLPackage.eINSTANCE.getPackage_PackagedElement(), Model.class },
				{ CreationToolsIds.CREATE__PACKAGE__TOOL, MappingTypes.PACKAGE_NODE_TYPE, List.of(MappingTypes.PACKAGE_NODE_CPD_PACKAGED_ELEMENTS_COMPARTMENT_TYPE), UMLPackage.eINSTANCE.getPackage_PackagedElement(), Package.class }
		});
	}
}
