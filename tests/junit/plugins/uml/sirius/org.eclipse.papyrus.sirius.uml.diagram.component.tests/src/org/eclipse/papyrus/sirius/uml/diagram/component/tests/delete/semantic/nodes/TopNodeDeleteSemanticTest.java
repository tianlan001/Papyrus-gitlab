...
/**
 * Groups all the tests related to node deletion on the root of a Component diagram.
 *
...
public class TopNodeDeleteSemanticTest extends AbstractDeleteSemanticNodeTest {
	...
	private static final String DIAGRAM_NAME = "TopNodeDeleteComponentDiagramSirius"; //$NON-NLS-1$
