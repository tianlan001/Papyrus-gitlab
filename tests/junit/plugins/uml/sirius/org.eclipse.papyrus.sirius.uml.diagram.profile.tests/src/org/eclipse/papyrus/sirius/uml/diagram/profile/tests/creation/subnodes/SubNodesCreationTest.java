...
public class SubNodesCreationTest extends AbstractCreateNodeTests {
	...
	public void createNodeIntoProfile() {
		createNodeIntoContainer(PROFILE, MappingTypes.PROFILE_NODE_TYPE, MappingTypes.PROFILE_NODE_PRD_PACKAGEDELEMENTSCOMPARTMENT_TYPE);
	}

	@Test
	@ActiveDiagram(DIAGRAM_NAME)
	public void createNodeIntoPackage() {
		createNodeIntoContainer(PACKAGE, MappingTypes.PACKAGE_NODE_TYPE, MappingTypes.PACKAGE_NODE_PRD_PACKAGEDELEMENTSCOMPARTMENT_TYPE);
	}
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] {
				...
				{ CreationToolsIds.CREATE__PRIMITIVETYPE__TOOL, MappingTypes.PRIMITIVETYPE_NODE_TYPE, UMLPackage.eINSTANCE.getPackage_PackagedElement(), PrimitiveType.class },
		});
	}
