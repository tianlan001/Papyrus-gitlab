...
public class CreateTopNodeOnProfileTest extends AbstractCreateTopNodeOnDiagramTests {
	 ...
	 *
	 */
	public CreateTopNodeOnProfileTest(String creationToolId, String nodeMappingType, EReference containmentFeature, Class<? extends Element> expectedType) {
