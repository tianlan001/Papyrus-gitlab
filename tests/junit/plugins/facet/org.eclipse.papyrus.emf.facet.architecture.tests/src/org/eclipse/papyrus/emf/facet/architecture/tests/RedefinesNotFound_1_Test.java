...
@PluginResource("resources/RedefinesNotFound/RedefinesNotFound_1_Test.architecture")
public class RedefinesNotFound_1_Test extends AbstractTest {
	...
	public void test() {
		...
		for (final Diagnostic diag : diagnostics) {
			...
			Assert.assertTrue(diag.getData().get(0) instanceof Redefinition);
			Assert.assertEquals(CustomizationMergeErrorCode.MERGE_ERROR__REDEFINE_NOT_FOUND, diag.getCode());
		}
	}
