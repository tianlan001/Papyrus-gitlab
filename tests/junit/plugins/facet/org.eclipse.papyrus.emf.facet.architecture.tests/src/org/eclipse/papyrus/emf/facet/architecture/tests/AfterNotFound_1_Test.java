...
@PluginResource("resources/AfterNotFound/AfterNotFound_1_Test.architecture")
public class AfterNotFound_1_Test extends AbstractTest {
	...
	public void test() {
		...
		for (final Diagnostic diag : diagnostics) {
			...
			Assert.assertEquals(CustomizationMergeErrorCode.MERGE_ERROR__AFTER_NOT_FOUND, diag.getCode());
		}
	}
