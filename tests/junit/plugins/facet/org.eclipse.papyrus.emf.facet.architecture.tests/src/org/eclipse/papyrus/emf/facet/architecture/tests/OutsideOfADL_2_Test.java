...
@PluginResource("resources/OutsideOfADL/OutsideOfADL_2_Test.architecture")
public class OutsideOfADL_2_Test extends AbstractTest {
	...
	public void test() {
		...
		Assert.assertEquals(CustomizationMergeErrorCode.CHECK_ERROR__REFERENCE_OUTSIDE_OF_ADL, diag.getCode());
	}
}
