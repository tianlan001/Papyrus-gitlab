...
@PluginResource("resources/AbsoluteOrderInRoot/AbsoluteOrderInRoot_2_Test.architecture")
public class AbsoluteOrderInRoot_2_Test extends AbstractTest {
	...
	public void test() {
		...
		for (final Diagnostic diag : diagnostics) {
			...
			Assert.assertEquals(CustomizationMergeErrorCode.CHECK_ERROR__NOT_ONLY_USE_ABSOLUTE_ORDER_IN_ROOTS, diag.getCode());
		}
	}
