...
/**
 * <p>
 * Test if a {@link CompositeWidget} is a {@link Group}.
 * </p>
 *
 * <strong>OCL</strong>:
 * <code>widgetType.widgetClass = 'Group' and widgetType.namespace.oclIsUndefined()</code>
 */
public class IsGroupQuery implements JavaQuery {
	...
	public boolean match(Object selection) {
		...
		if (!(selectedEObject instanceof CompositeWidget)) {
			return false;
		}
		CompositeWidget source = (CompositeWidget) selectedEObject;
		CompositeWidgetType widgetType = source.getWidgetType();
		return widgetType != null
				&& Group.class.getSimpleName().equals(widgetType.getWidgetClass())
				&& widgetType.getNamespace() == null;
	}
