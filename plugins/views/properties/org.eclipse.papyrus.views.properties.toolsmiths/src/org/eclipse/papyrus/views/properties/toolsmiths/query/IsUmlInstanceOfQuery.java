...
/**
 * <p>
 * Test if a {@link SimpleConstraint} is a org.eclipse.papyrus.uml.properties.constraints.UmlInstanceOfConstraint.
 * </p>
 *
 * <strong>OCL</strong>:
 * <code>self.constraintType.constraintClass = 'org.eclipse.papyrus.uml.properties.constraints.UmlInstanceOfConstraint'</code>
 */
public class IsUmlInstanceOfQuery implements JavaQuery {
	...
	public boolean match(Object selection) {
		...
		// UmlInstanceOfConstraint is part of UML Properties. We don't want to introduce a hard dependency, so we just
		// test it by (String) qualified name.
		ConstraintType constraintType = source.getConstraintType();
		return constraintType != null && "org.eclipse.papyrus.uml.properties.constraints.UmlInstanceOfConstraint".equals(constraintType.getConstraintClass());
	}
