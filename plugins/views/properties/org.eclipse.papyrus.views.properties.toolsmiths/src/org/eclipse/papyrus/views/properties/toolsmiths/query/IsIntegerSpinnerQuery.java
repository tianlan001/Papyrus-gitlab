...
import org.eclipse.papyrus.infra.properties.ui.widgets.IntegerSpinner;

/**
 * <p>
 * Test if a {@link PropertyEditor} is an {@link IntegerSpinner}.
 * </p>
 *
 * <strong>OCL</strong>:
 * <code>widgetType.widgetClass = 'IntegerSpinner' and widgetType.namespace.name = 'ppe'</code>
 */
public class IsIntegerSpinnerQuery implements JavaQuery {
	...
	public boolean match(Object selection) {
		...
		return QueryUtil.matches(source, IntegerSpinner.class);
	}
}
