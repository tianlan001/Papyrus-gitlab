...
/**
 * <p>
 * Test if a {@link SimpleConstraint} is an {@link EMFInstanceOfConstraint}.
 * </p>
 *
 * <strong>OCL</strong>:
 * <code>self.constraintType.constraintClass = 'org.eclipse.papyrus.infra.constraints.constraints.EMFInstanceOfConstraint'</code>
 */
public class IsEcoreInstanceOfQuery implements JavaQuery {
	...
	public boolean match(Object selection) {
		...
		return QueryUtil.matches(source, EMFInstanceOfConstraint.class);
	}
}
