...
/**
 * This class is used to convert the Sirius Profile Application description into
 * the EEF one.
 * 
 * @author <a href="mailto:glenn.plouhinec@obeo.fr">Glenn Plouhinec</a>
 */
public class ProfileApplicationDescriptionConverter extends DefaultDescriptionWithInitialOperationConverter<ProfileApplicationDescription> {

	/**
	 * Constructor.
	 */
	public ProfileApplicationDescriptionConverter() {
		super(ProfileApplicationDescription.class, EefAdvancedControlsPackage.Literals.EEF_PROFILE_APPLICATION_DESCRIPTION, null);
	}
