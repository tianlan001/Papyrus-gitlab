...
/**
 * This is the item provider adapter for a {@link org.eclipse.papyrus.sirius.properties.advanced.controls.propertiesadvancedcontrols.ProfileApplicationDescription} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProfileApplicationDescriptionItemProvider extends WidgetDescriptionItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ProfileApplicationDescriptionItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns ProfileApplicationDescription.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ProfileApplicationDescription")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((ProfileApplicationDescription) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_ProfileApplicationDescription_type") : //$NON-NLS-1$
				getString("_UI_ProfileApplicationDescription_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ProfileApplicationDescription.class)) {
