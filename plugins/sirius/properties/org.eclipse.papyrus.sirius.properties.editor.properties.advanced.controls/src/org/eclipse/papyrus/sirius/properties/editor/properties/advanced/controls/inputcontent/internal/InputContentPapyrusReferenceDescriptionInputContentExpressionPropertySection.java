...
/**
 * The property section for the Input Content Expression text field of the
 * Input Content Papyrus Reference Widget.
 * 
 * @author <a href="mailto:glenn.plouhinec@obeo.fr">Glenn Plouhinec</a>
 */
@SuppressWarnings("restriction")
public class InputContentPapyrusReferenceDescriptionInputContentExpressionPropertySection
		extends AbstractTextWithButtonPropertySection implements ContentProposalClient {

	@Override
	protected String getDefaultLabelText() {
		return "InputContentExpression"; //$NON-NLS-1$
	}
		...
		return new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(),
						InputContentPapyrusReferenceDescriptionInputContentExpressionPropertySection.this, text.getText());
				dialog.open();
