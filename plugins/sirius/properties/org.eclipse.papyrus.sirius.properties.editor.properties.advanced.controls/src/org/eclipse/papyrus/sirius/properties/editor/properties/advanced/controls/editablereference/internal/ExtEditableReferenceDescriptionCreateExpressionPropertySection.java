...
/**
 * The property section for the Create Expression text field of the Editable
 * Reference Widget.
 * 
 * @author <a href="mailto:glenn.plouhinec@obeo.fr">Glenn Plouhinec</a>
 */
@SuppressWarnings("restriction")
public class ExtEditableReferenceDescriptionCreateExpressionPropertySection
		extends AbstractTextWithButtonPropertySection implements ContentProposalClient {

	@Override
	protected String getDefaultLabelText() {
		return "CreateExpression"; //$NON-NLS-1$
	}
	...
	public EAttribute getFeature() {
		return PropertiesAdvancedControlsPackage.eINSTANCE.getExtEditableReferenceDescription_CreateExpression();
	}
		...
		return new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(),
						ExtEditableReferenceDescriptionCreateExpressionPropertySection.this, text.getText());
				dialog.open();
