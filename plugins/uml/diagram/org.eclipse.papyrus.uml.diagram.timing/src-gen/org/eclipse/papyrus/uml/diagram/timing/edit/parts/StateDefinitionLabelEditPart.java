 ...
 * @generated
 */
public class StateDefinitionLabelEditPart extends AbstractNodeLabelEditPart {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "Node_StateDefinitionNameLabel"; //$NON-NLS-1$
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.Node_StateDefinitionShape, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
}
